...
{
    public static function getServiceNameByEntity(EntityInterface $entity, string $event = 'service_collection')
    {
        $entityClass = EntityClassHelper::getEntityClass($entity);
        return self::getServiceNameByEntityFqdn($entityClass, $event);
    }

    public static function getServiceNameByEntityFqdn(string $entityClass, string $event)
    {
